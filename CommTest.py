...
CommComp2.do(numOfPeers, [os.path.join('.','fileTran','entity_2'), os.path.join('.','fileTran','entity_2')],
            [os.path.join('.','fileRecv','entity_2'), os.path.join('.','fileRecv','entity_2')],
            ['10.206.203.243', '10.152.144.160'])
...
# CommComp3.do(numOfPeers, [os.path.join('.','fileTran','entity_3'), os.path.join('.','fileTran','entity_2')],
#             [os.path.join('.','fileRecv','entity_3'), os.path.join('.','fileRecv','entity_2')],
#             ['10.206.203.243', '10.152.144.160'])
#
# ########################################################################################
# print '.......simulation going on.........'
